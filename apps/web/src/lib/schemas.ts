...
const trimEmptyToUndefined = (value: unknown) => {
...
export const projectInputSchema = z.object({
  ...
  description: z.preprocess(trimEmptyToUndefined, z.string().max(500).optional()),
  ...
  owner: z.preprocess(trimEmptyToUndefined, z.string().max(100).optional()),
...
export const componentInputSchema = z.object({
  ...
  framework: z.preprocess(trimEmptyToUndefined, z.string().max(50).optional()),
  runtime: z.preprocess(trimEmptyToUndefined, z.string().max(50).optional()),
  language: z.preprocess(trimEmptyToUndefined, z.string().max(50).optional()),
