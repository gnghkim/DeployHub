...
export const config = {
  matcher: [
    '/((?!api/auth(?:/|$)|api/v1/manifest/(?:schema|template|validate)/?$|api/v1/project-drafts/?$|api/v1/projects/[^/]+/(?:manifest|status)/?$|schemas/deployhub-v1[.]json/?$|_next/static|_next/image|favicon[.]ico$).*)',
  ],
};
